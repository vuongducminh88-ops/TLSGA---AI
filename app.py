...
<div class="main-header">
    ...
    <p>Tác giả: Vương Đức Minh - Trường PTDTBT Tiểu học Đường Thượng - ĐT: 0948344754 </p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Vương Đức Minh - Trường PTDTBT Tiểu học Đường Thượng - ĐT: 0948344754</div>", unsafe_allow_html=True)
